...
**这里有新的更详细的文档→[新版文档](/pages/serverpack2)**
...
![](/pages/assets/img/docs/serverpack/1.png)

选择导出为服务器自动更新整合包：

![](/pages/assets/img/docs/serverpack/1-1.png)

填写整合包信息，整合包下载链接前缀如何填写请看下文，你也可以先填别的（必须是个链接，比如 http://www.baidu.com），该项在整合包导出后可以修改

![](/pages/assets/img/docs/serverpack/1-2.png)
...
![](/pages/assets/img/docs/serverpack/1-3.png)
...
![](/pages/assets/img/docs/serverpack/1-4.png)
...
![](/pages/assets/img/docs/serverpack/1-6.png)
