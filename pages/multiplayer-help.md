...
![多人联机界面](/pages/assets/img/docs/multiplayer/help/img1.png)
...
![游戏地图创建局域网成功画面](/pages/assets/img/docs/multiplayer/help/In-game.png)

此时，请回到 HMCL 多人联机界面。点击 `创建房间` ，您将看到您的局域网游戏已经被正确识别。

单击确认按钮，即可创建房间。

![create-room](/pages/assets/img/docs/multiplayer/help/create-room.png)
...
**请先查看 [HMCL 多人联机常见问题解答](/pages/multiplayer-faq.md) 后再到 [GitHub](https://github.com/huanghongxun/HMCL) 进行反馈！**
